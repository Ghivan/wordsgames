...
class Model{
    private user: User;
    readonly urlChangeLogin: string = 'server_scenarios/index.php';
    readonly urlChangeEmail: string = 'server_scenarios/index.php';
    readonly urlChangePassword: string = 'server_scenarios/index.php';
    readonly urlChangeAvatar: string = 'server_scenarios/index.php';
    readonly urlSendFeedback: string = 'server_scenarios/index.php';
